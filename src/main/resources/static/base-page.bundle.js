...
Init.albums = function () {
  ...
  $('.music-collection').gridCollection().pageScroller({ scrollPadding: 75, prototypingMode: thPrototypingMode }).itemsWithContent({
...
Init.artists = function () {
  ...
  $('.music-collection').gridCollection().pageScroller({ scrollPadding: 25, prototypingMode: thPrototypingMode }).itemsWithContent({
...
Init.genres = function () {
  ...
  $('.music-collection').gridCollection().pageScroller({ scrollPadding: 65, prototypingMode: thPrototypingMode }).itemsWithContent({
    itemSelector: 'div.genre button[class*="genre-content"], div.genre button[class*="genre-subgenres"]',
    prototypingMode: thPrototypingMode
  });

  var decoratingLinesMargins = 40; // added as :before and :after pseudo elements
  var decoratingLinesMinSpace = decoratingLinesMargins + 40;
  var genreDivSpanWidth = $('div.genre div[class$="genre__title-wrapper"]').width();
...
var initialPageInit = document.currentScript.getAttribute('data-initial-page-init');
...
function loadPage(url, onLoad) {
  var promise = (0, _ajax.fetch)(url, thPrototypingMode);
...
function fetch(url) {
  var prototypingMode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
if (!thPrototypingMode) {
  ...
  window.onpopstate = function (event) {
    var poppedState = event.state == null ? INITIAL_STATE : event.state;
    (0, _application.loadPage)(poppedState.pageUrl);
  };
} /* global window */
/* global thPrototypingMode */
...
var _cssElementQueries = __webpack_require__(42);

var _flexSpaceAroundHelper = __webpack_require__(27);
 ...
 */
_jquery2.default.widget('ui.gridCollection', {
  _create: function _create() {
    this._addStyles();

    var flexSpaceAroundHelper = new _flexSpaceAroundHelper.FlexSpaceAroundHelper(this.element);
    ...
    var sensor = new _cssElementQueries.ResizeSensor(this.element[0], function () {
  ...
  _destroy: function _destroy() {
    ...
    observer.observe(this.element[0], { childList: true });
    (0, _jquery2.default)('resize-sensor').remove();
  },
  _addStyles: function _addStyles() {
    ...
    this.element.children('div:not(.resize-sensor)').each(function () {
      (0, _jquery2.default)(this).addClass('grid-collection__item');
    });
  }
...
_jquery2.default.widget('ui.itemsWithContent', {
  ...
  _create: function _create() {
    ...
    var isWaitingForAjaxResults = false;
    widget.element.on('click', this.options.itemSelector, function () {
      if (!isWaitingForAjaxResults) {
        isWaitingForAjaxResults = true;
        var itemPageUrl = (0, _jquery2.default)(this).data('item-page-url');
        (0, _application.loadPage)(itemPageUrl, function () {
 ...
 *                 </ol>
 */
_jquery2.default.widget('ui.pageScroller', {
  ...
  _create: function _create() {
    var widget = this;
    var nextPageUrl = widget.element.data('initial-next-page-url');
    ...
    this.scrollListener = function () {
      ...
      if ((0, _jquery2.default)(this).scrollTop() >= (0, _jquery2.default)(this).prop('scrollHeight') - (0, _jquery2.default)(this).height() - widget.options.scrollPadding) {
        if (!isWaitingForAjaxResults && nextPageUrl) {
          isWaitingForAjaxResults = true;
          var promise = (0, _ajax.fetch)(nextPageUrl, widget.options.prototypingMode);
          promise.then(function (request) {
            (0, _jquery2.default)(_this).append(request.response);
            if (!widget.options.prototypingMode) {
  ...
  _getNextUrlFromHeader: function _getNextUrlFromHeader(header) {
 ...
 *
 */
_jquery2.default.widget('ui.textfit', {
  ...
  _create: function _create() {
    ...
    var $resizedElems = this.element.find(opts.innerTag + ':visible:first');
    $resizedElems.css('white-space', 'nowrap');
    this.originalFontSize = $resizedElems.css('font-size');

    var userFailCallback = opts.fail;
    var internalFailCallback = function internalFailCallback(textfill) {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./albums.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./albums.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./artists.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./artists.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./genres.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./genres.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./greetings.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./greetings.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./main.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./main.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./menu.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./menu.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./music-info.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./music-info.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./shared.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./shared.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./songs.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./songs.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./soundtracks.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./soundtracks.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./thematic-compilations.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./thematic-compilations.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
exports.FlexSpaceAroundHelper = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _templateObject = _taggedTemplateLiteral(['FlexSpaceAroundHelper(init):\n    childrenCount = ', ';\n    childMarginRight = ', ';\n    childHorizontalSpace = ', ';'], ['FlexSpaceAroundHelper(init):\n    childrenCount = ', ';\n    childMarginRight = ', ';\n    childHorizontalSpace = ', ';']),
    _templateObject2 = _taggedTemplateLiteral(['FlexSpaceAroundHelper(run):\n        divWidth = ', ';\n        childrenInOneRow = ', ';\n        gapsExtraSpacePerChild = ', ';\n        missingChildrenInLastRow = ', ';\n        freeSpaceLeft = ', ''], ['FlexSpaceAroundHelper(run):\n        divWidth = ', ';\n        childrenInOneRow = ', ';\n        gapsExtraSpacePerChild = ', ';\n        missingChildrenInLastRow = ', ';\n        freeSpaceLeft = ', '']);

var _dedentJs = __webpack_require__(57);
...
function _taggedTemplateLiteral(strings, raw) { return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } /* eslint-disable import/prefer-default-export */
...
function init(instance) {
  ...
  instance[childHorizontalSpace] = parseInt(instance[lastChild].css('width')) + instance[childMarginRight] + parseInt(instance[lastChild].css('marginLeft'));

  console.log((0, _dedentJs2.default)(_templateObject, instance[childrenCount], instance[childMarginRight], instance[childHorizontalSpace]));
}
...
var FlexSpaceAroundHelper = function () {
   ...
   */
  function FlexSpaceAroundHelper(_$flexedDiv) {
    _classCallCheck(this, FlexSpaceAroundHelper);
  ...
  _createClass(FlexSpaceAroundHelper, [{
    key: 'refresh',
    ...
    key: 'squeezeChildrenToLeftInLastRow',
    value: function squeezeChildrenToLeftInLastRow() {
      var divWidth = this[$flexedDiv].prop('clientWidth');
      var childrenInOneRow = Math.floor(divWidth / this[childHorizontalSpace]);
      var missingChildrenInLastRow = childrenInOneRow - this[childrenCount] % childrenInOneRow;
      var marginRestored = false;

      if (missingChildrenInLastRow < childrenInOneRow) {
        var gapsExtraSpacePerChild = (divWidth - childrenInOneRow * this[childHorizontalSpace]) / childrenInOneRow;
        var freeSpaceLeft = missingChildrenInLastRow * (this[childHorizontalSpace] + gapsExtraSpacePerChild);

        this[lastChild].css('marginRight', freeSpaceLeft + this[childMarginRight]);

        console.log((0, _dedentJs2.default)(_templateObject2, divWidth, childrenInOneRow, gapsExtraSpacePerChild, missingChildrenInLastRow, freeSpaceLeft));
...
exports.FlexSpaceAroundHelper = FlexSpaceAroundHelper;

/***/ }),
/* 28 */
/***/ (function(module, exports, __webpack_require__) {

module.exports.css = __webpack_require__ (73);
...
module.exports = {
    ResizeSensor: __webpack_require__(6),
    ElementQueries: __webpack_require__(43)
};
...
// module
exports.push([module.i, ".genre {\n  flex: 0 1 260px;\n  height: 150px;\n  z-index: 1;\n}\n.genre__content {\n  background: rgba(0, 0, 0, 0.4);\n}\n.genre__title-wrapper {\n  height: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  color: white;\n  text-shadow: 0px 0px 8px rgba(0, 0, 0, 0.7);\n  line-height: 1;\n  text-align: center;\n}\n.genre__title-wrapper:before,\n.genre__title-wrapper:after {\n  height: 1px;\n  width: 50%;\n  margin: 10px;\n  display: inline-block;\n  content: \"\";\n  background: rgba(255, 255, 255, 0.5);\n  box-shadow: 0 0 3px rgba(255, 255, 255, 0.5), 0 0 8px #ffffff, 0 0 16px #ffffff;\n}\n.btn-a--genre-content,\n.btn-a--genre-subgenres {\n  width: 100%;\n  height: 50%;\n  font-size: 16px;\n  text-shadow: 0px 0px 5px rgba(0, 0, 0, 0.7);\n}\n.btn-a--genre-content {\n  padding-bottom: 10px;\n}\n.btn-a--genre-subgenres {\n  padding-top: 10px;\n}\n@keyframes btn-a--genre-hover {\n  to {\n    transform: scale(1.2);\n  }\n}\n.btn-a--genre-content:hover,\n.btn-a--genre-subgenres:hover {\n  animation-name: btn-a--genre-hover;\n  animation-duration: 0.2s;\n  animation-fill-mode: forwards;\n}\n", ""]);
...
// module
exports.push([module.i, ".greetings__header {\n  padding: 15px 0px;\n  font-size: 20px;\n  font-weight: bold;\n}\n.greetings__text {\n  font-size: 16px;\n}\n", ""]);
...
// module
exports.push([module.i, ".grid-collection {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-around;\n  align-content: flex-start;\n}\n.grid-collection__item {\n  margin: 10px;\n  overflow: hidden;\n  border-radius: 8px;\n  box-shadow: 0 0 8px #b2b2b2;\n}\n", ""]);
...
// module
exports.push([module.i, ".menu {\n  height: 120px;\n}\n.menu__buttons {\n  height: 100%;\n  width: 100%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.menu__background {\n  height: 100%;\n  width: 100%;\n  /* background-image: url(Main-content__menu-background.jpg); */\n  /*background: rgb(25, 12, 53);*/\n  background: #190c35;\n}\n.btn-a--menu:active {\n  color: #afafaf;\n}\n.btn-a--menu:hover {\n  color: #3c3c3c;\n}\n.btn-a--menu {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 200px;\n  height: 65px;\n  margin: 15px;\n  padding: 5px;\n  background: rgba(255, 255, 255, 0.9);\n  border: 1px solid rgba(255, 255, 255, 0.9);\n  border-radius: 30px;\n  font-size: 20px;\n  color: #808080;\n}\n", ""]);
...
// module
exports.push([module.i, ".music-info {\n  overflow: hidden;\n  background: black;\n  min-height: 180px;\n}\n.music-info .fade-edge.fade-edge--bottom.fade-edge--white {\n  height: 3px;\n}\n.music-info__background-img-wrapper {\n  width: 100%;\n  height: auto;\n  position: relative;\n}\n.music-info__background-img-wrapper img {\n  width: 100%;\n  height: auto;\n}\n.music-info__background-img-wrapper .fade-edge.fade-edge--bottom.fade-edge--black {\n  height: 100px;\n}\n.music-info__content {\n  min-height: 180px;\n  background: rgba(0, 0, 0, 0.4);\n}\n.music-info__title {\n  padding: 40px 0px 5px;\n  margin: 0px;\n  text-align: center;\n  color: white;\n}\n.music-info__expand-btn {\n  margin: 4px auto 4px;\n  padding: 5px 15px;\n  height: 35px;\n  display: block;\n  color: white;\n  background: rgba(0, 0, 0, 0);\n  border-radius: 10px;\n  border: 1px solid rgba(255, 255, 255, 0.3);\n  box-shadow: 0 0 8px rgba(255, 255, 255, 0.2), inset 0 0 8px rgba(255, 255, 255, 0.2);\n}\n.music-info__expand-btn-wrapper {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  margin-top: 10px;\n  padding: 10px 0px;\n}\n.music-info__expand-btn-wrapper:before,\n.music-info__expand-btn-wrapper:after {\n  width: 0;\n  height: 0;\n  content: \"\";\n  display: block;\n  border-left: 20px solid transparent;\n  border-right: 20px solid transparent;\n}\n.music-info__expand-btn-wrapper:before {\n  display: none;\n  border-bottom: 20px solid rgba(255, 255, 255, 0.3);\n}\n.music-info__expand-btn-wrapper:after {\n  display: none;\n  border-top: 20px solid rgba(255, 255, 255, 0.3);\n}\n.music-info__expand-btn-wrapper--show-before:before {\n  display: block;\n}\n.music-info__expand-btn-wrapper--show-after:after {\n  display: block;\n}\n@keyframes expand-music-info-btn {\n  from {\n    font-size: 16px;\n  }\n  to {\n    font-size: 17px;\n  }\n}\n.music-info__expand-btn:hover {\n  background: rgba(0, 0, 0, 0);\n  animation-name: expand-music-info-btn;\n  animation-duration: 0.2s;\n  animation-fill-mode: forwards;\n}\n.music-info__expand-btn:focus {\n  outline: none;\n}\n.music-info__details {\n  padding: 25px 15px 10px;\n  color: white;\n  display: none;\n}\n", ""]);
...
// module
exports.push([module.i, "/**************************************/\n/********** Navigation block **********/\n/**************************************/\n.navigation {\n  margin: 5px 0px;\n}\n.navigation__divider {\n  padding: 0 3px;\n}\n.btn-a--navigation {\n  font-size: 14px;\n  color: black;\n}\n.btn-a--navigation :hover {\n  color: #787878;\n}\n.btn-a--navigation :active {\n  color: #bebebe;\n}\n/**************************************/\n/*********** Comments block ***********/\n/**************************************/\n.comments {\n  min-height: 400px;\n  background: #dbfcff;\n}\n/**************************************/\n/*********** Controls block ***********/\n/**************************************/\n/**************************************/\n/******* Music collection block *******/\n/**************************************/\n.music-collection {\n  height: 600px;\n  overflow-y: auto;\n}\n/**************************************/\n/*************** Others ***************/\n/**************************************/\n@media (min-width: 992px) {\n  .row--equal-columns {\n    display: flex;\n  }\n}\n.container-with-background {\n  position: relative;\n}\n.container-with-background__background-wrapper {\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  top: 0;\n  left: 0;\n}\n.container-with-background__foreground-wrapper {\n  width: 100%;\n  height: 100%;\n  position: relative;\n}\n.container-with-foreground {\n  position: relative;\n}\n.container-with-foreground__foreground-wrapper {\n  position: absolute;\n  top: 0;\n  z-index: 1;\n}\n.btn-a {\n  background-color: Transparent;\n  background-repeat: no-repeat;\n  border: none;\n  cursor: pointer;\n  overflow: hidden;\n  outline: none;\n}\n.btn-a--glow {\n  text-align: center;\n  color: white;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.btn-a--glow:hover {\n  text-shadow: 0 0 50px #ffffff, 0 0 40px #ffffff, 0 0 35px #ffffff;\n}\n.btn-a--glow:active {\n  color: #cccccc;\n  text-shadow: 0 0 50px #ffffff, 0 0 40px #ffffff, 0 0 40px #ffffff, 0 0 35px #ffffff;\n}\n.border--hover-fade-blue:hover {\n  box-shadow: 0 0 2px #235eff, 0 0 8px #2897ff;\n}\n.border--hover-fade-blue:active {\n  box-shadow: 0 0 2px #235eff, 0 0 8px #2897ff, 0 0 16px #2897ff;\n}\n.fade-edge {\n  /* Container must have position: relative; */\n  position: absolute;\n}\n.fade-edge--bottom {\n  width: 100%;\n  bottom: 0;\n}\n.fade-edge--black {\n  background: linear-gradient(to bottom, rgba(0, 0, 0, 0), #000000);\n}\n.fade-edge--white {\n  background: linear-gradient(to bottom, rgba(255, 255, 255, 0), #ffffff);\n}\n", ""]);
...
// module
exports.push([module.i, ".songs {\n  height: 600px;\n  overflow-y: auto;\n}\n.song {\n  height: 40px;\n  margin: 10px 15px;\n  padding: 0px 15px;\n  display: flex;\n  justify-content: flex-end;\n  align-items: center;\n  border: 1px solid #d7d7d7;\n  border-radius: 5px;\n  background: rgba(0, 0, 0, 0.05);\n}\n.song__order {\n  margin-right: 10px;\n}\n.song__name {\n  margin-right: auto;\n}\n.song__btn-purchase {\n  height: 100%;\n  padding: 0px 10px;\n  display: flex;\n  align-items: center;\n  border-radius: 0px;\n  color: #4b4b4b;\n  text-decoration: none;\n  background: rgba(0, 0, 0, 0.06);\n}\n.song__btn-purchase:link,\n.song__btn-purchase:visited,\n.song__btn-purchase:hover,\n.song__btn-purchase:active,\n.song__btn-purchase:focus {\n  text-decoration: none;\n}\n.song__btn-purchase:hover {\n  color: black;\n  background: rgba(0, 0, 0, 0.12);\n}\n.song__btn-purchase:active {\n  color: black;\n  background: rgba(0, 0, 0, 0.18);\n}\n.song__btn-purchase:focus {\n  color: #4b4b4b;\n}\n", ""]);
...
// module
exports.push([module.i, ".soundtrack {\n  flex: 0 1 280px;\n  height: 330px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-content: center;\n}\n.soundtrack__cover {\n  width: 100%;\n  flex-grow: 1;\n  overflow: hidden;\n}\n.soundtrack__cover img {\n  width: 100%;\n  height: auto;\n}\n.soundtrack__short-info {\n  width: 100%;\n  padding: 5px 5px;\n  text-align: left;\n  font-weight: bold;\n}\n", ""]);
...
// module
exports.push([module.i, ".thematic-compilation {\n  flex: 0 1 260px;\n  height: 150px;\n  z-index: 1;\n}\n.thematic-compilation__content {\n  background: rgba(0, 0, 0, 0.25);\n}\n.btn-a--thematic-compilation {\n  width: 100%;\n  height: 100%;\n  padding: 0px 20px;\n  text-shadow: 0px 0px 8px rgba(0, 0, 0, 0.5);\n}\n@keyframes btn-a--thematic-compilation-hover {\n  to {\n    transform: scale(1.2);\n  }\n}\n.btn-a--thematic-compilation:hover {\n  animation-name: btn-a--thematic-compilation-hover;\n  animation-duration: 0.2s;\n  animation-fill-mode: forwards;\n}\n", ""]);
...
module.exports = __webpack_require__.p + "header_left.png";

/***/ }),
/* 59 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "header_right.png";
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./grid-collection.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./grid-collection.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../resolve-url-loader/index.js!../sass-loader/lib/loader.js?sourceMap!./lib/bootstrap.styles.loader.js?{\"bootstrapVersion\":3,\"useCustomIconFontPath\":false,\"extractStyles\":false,\"styleLoaders\":[\"style\",\"css\",\"sass\"],\"styles\":[\"mixins\",\"normalize\",\"print\",\"glyphicons\",\"scaffolding\",\"type\",\"code\",\"grid\",\"tables\",\"forms\",\"buttons\",\"component-animations\",\"dropdowns\",\"button-groups\",\"input-groups\",\"navs\",\"navbar\",\"breadcrumbs\",\"pagination\",\"pager\",\"labels\",\"badges\",\"jumbotron\",\"thumbnails\",\"alerts\",\"progress-bars\",\"media\",\"list-group\",\"panels\",\"wells\",\"responsive-embed\",\"close\",\"modals\",\"tooltip\",\"popovers\",\"carousel\",\"utilities\",\"responsive-utilities\"],\"scripts\":[\"transition\",\"alert\",\"button\",\"carousel\",\"collapse\",\"dropdown\",\"modal\",\"tooltip\",\"popover\",\"scrollspy\",\"tab\",\"affix\"],\"configFilePath\":\"D:\\\\MyData\\\\Игорек\\\\DocumentsAll\\\\Studies\\\\Java\\\\Projects\\\\MusicStore\\\\musicstore\\\\src\\\\main\\\\resources\\\\application\\\\node_modules\\\\bootstrap-loader\\\\.bootstraprc-3-default\",\"bootstrapPath\":\"D:\\\\MyData\\\\Игорек\\\\DocumentsAll\\\\Studies\\\\Java\\\\Projects\\\\MusicStore\\\\musicstore\\\\src\\\\main\\\\resources\\\\application\\\\node_modules\\\\bootstrap-sass\",\"bootstrapRelPath\":\"..\\\\bootstrap-sass\"}!./no-op.js", function() {
