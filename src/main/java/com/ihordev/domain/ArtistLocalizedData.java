...
public class ArtistLocalizedData {
    ...
    protected ArtistLocalizedData() {}

    public ArtistLocalizedData(String name, String description, Artist artist, Language language) {
        this.name = name;
        this.description = description;
        this.artist = artist;
    ...
    public boolean equals(@Nullable Object o) {
        ...
        if (!(o instanceof ArtistLocalizedData)) return false;

        ArtistLocalizedData that = (ArtistLocalizedData) o;
