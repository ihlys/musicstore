...
/**
 * <p> A {@code BeanPostProcessor} that registers specified named queries and
 * named native queries in {@code EntityManagerFactory} after
 * {@code EntityManager} is initialized.
 * It takes an instance of {@link EntityManagerFactory} from
 * {@link EntityManager} and uses it's
 * {@link EntityManagerFactory#addNamedQuery(String, Query)} method to register
